...
(* OASIS_START *)
(* DO NOT EDIT (digest: 856d2f520ad40efcc97bac256b9f4dfe) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "cancel_utils_test.ml"
                   });
               Executable
                 ({
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\rU\228\178\182\253e\196rr\153<\000\208p\128";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
